<template>
    <div v-if="visible" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60">
        <div class="bg-white rounded-xl shadow-2xl w-full max-w-lg p-6 animate-fadeIn">
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <!-- CARA BAYAR -->
                <div class="flex flex-col gap-1">
                    <label class="text-sm font-medium">Cara Bayar *</label>
                ...
                <!-- HARGA KIRIM -->
                <div class="flex flex-col gap-1">
                    <label class="text-sm font-medium">Harga Kirim *</label>
                ...
                <div class="flex flex-col gap-1 col-span-2">
                    ...
                    <textarea v-model="form.alamat" rows="2"
                        class="border border-gray-300 bg-white rounded-lg px-3 py-2 focus:ring-2 focus:ring-blue-400 outline-none"></textarea>
                </div>
            </div>
