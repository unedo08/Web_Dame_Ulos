  ...
  <div v-if="visible" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
    <div class="bg-white rounded-lg shadow-xl max-w-[55%] w-full overflow-y-auto p-6 relative">
      ...
      <form class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div class="space-y-4">
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Kode Barang <span class="required">*</span></label>
            <input
              ref="kodeBarangInput"
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Platform <span class="required">*</span></label>
            <input
              ref="platformInput"
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Nama Penerima <span class="required">*</span></label>
            <input
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Pengiriman <span class="required">*</span></label>
            <input
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Metode Pembayaran <span class="required">*</span></label>
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Alamat <span class="required">*</span></label>
            <textarea
              v-model="form.alamat"
              :disabled="!form.code_barang"
              rows="3"
        ...
        <div class="space-y-4">
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Nama Akun <span class="required">*</span></label>
            <input
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Harga Terjual <span class="required">*</span></label>
            <div class="flex">
              <span class="bg-gray-100 border border-gray-300 rounded-l-md px-3 flex items-center text-gray-600">Rp</span>
              <input
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Nomor Telepon <span class="required">*</span></label>
            <input
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Biaya Pengiriman <span class="required">*</span></label>
            <div class="flex">
              <span class="bg-gray-100 border border-gray-300 rounded-l-md px-3 flex items-center text-gray-600">Rp</span>
              <input
          ...
          <div>
            <label class="judul-label block text-sm font-medium text-gray-700 mb-1">Catatan <span class="required">*</span></label>
            <textarea
