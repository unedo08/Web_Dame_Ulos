  ...
  <div class="max-w-6xl mx-auto p-8 bg-white rounded-lg shadow-md">
    ...
    <form @submit.prevent="submitForm" class="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      <div class="space-y-4">
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Harga Terjual *</label>
          <div class="relative">
            <span class="absolute left-3 top-2.5 text-gray-500">Rp</span>
            <input v-model="form.hargaTerjual" type="number"
              class="w-full border border-gray-300 rounded-md px-10 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" />
          </div>
        </div>

        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Nama Telepon *</label>
          <input v-model="form.namaTelepon" type="text"
            class="w-full border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" />
        </div>
        ...
        <div>
          ...
          <div class="relative">
            <span class="absolute left-3 top-2.5 text-gray-500">Rp</span>
            <input v-model="form.biayaPengiriman" type="number"
              class="w-full border border-gray-300 rounded-md px-10 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500" />
          </div>
        </div>
